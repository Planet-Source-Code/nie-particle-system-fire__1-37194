...
DDC.Init Form1.hwnd, DDSCL_FULLSCREEN Or DDSCL_EXCLUSIVE, True


Set DX7_PS = DDC.mk_prim_surf(Form1.hwnd)
Set DX7_BS = DDC.mk_surf(DX7_BSR, "", 320, 240)
...
Dim tmpr As RECT
DX7_DX.GetWindowRect Form1.hwnd, tmpr
